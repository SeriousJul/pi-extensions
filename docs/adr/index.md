...
| [0027](/adr/0027-the-live-catalog-comparison-heals-the-window) | Llama refresh heals any window drift by comparing the catalog before and after one forced refresh, at two fixed heal moments; the fallback sentinel is no longer the gate. |
